  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        <div
          class="w-24 h-24 mx-auto mb-6 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-3xl flex items-center justify-center shadow-lg"
        >
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // App.vue wechselt automatisch auf Forum, weil store.isAuthenticated jetzt true ist
  } catch {
    error.value = authStore.error || "Login fehlgeschlagen. Bitte versuchen Sie es erneut."
  } finally {
